...
The backend agent runtime that actually performs work. Three drivers ship built in: Codex, Claude, and Kiro. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and [CodexAdapter.ts][17] as a representative adapter.
